...
import recomendaciones_Nutricion from "./recomenaciones_Nutricion";
...
export class Deportista extends Model<Deportista> {
  ...
  @HasMany(() =>recomendaciones_Nutricion)
  declare recomendaciones_nutricion:recomendaciones_Nutricion[];
